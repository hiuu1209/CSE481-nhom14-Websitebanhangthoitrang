                    ...
                    <div class="mt-5 ml-0 ml-xl-5">
                        <c:choose>
                            <c:when test = "${categoryName == 'Nữ'}">
                                ...
                                <a class='d-block mt-3 font-weight-bold link-active' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=Nữ'>Sản phẩm mới</a>
                            ...
                            <c:when test = "${categoryName == 'Nam' }">
                                ...
                                <a class='d-block mt-3 font-weight-bold link-active' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=Nam'>Sản phẩm mới</a>
                            ...
                            <c:when test = "${categoryName == 'Bé gái'}">
                                ...
                                <a class='d-block mt-3 font-weight-bold link-active' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=Bé gái'>Sản phẩm mới</a>
                            ...
                            <c:when test = "${categoryName == 'Bé trai'}">
                                 ...
                                 <a class='d-block mt-3 font-weight-bold link-active' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=Bé trai'>Sản phẩm mới</a>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '200000' && (minPrice == '0' || minPrice == null)}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice1" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice1" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=200000&minPrice=0')">
                                </c:otherwise>
                            </c:choose>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '400000' && minPrice == '200000'}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice2" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice2" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=400000&minPrice=200000')">
                                </c:otherwise>
                            </c:choose>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '600000' && minPrice == '400000'}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice3" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice3" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=600000&minPrice=400000')">
                                </c:otherwise>
                            </c:choose>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '800000' && minPrice == '600000'}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice4" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice4" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=800000&minPrice=600000')">
                                </c:otherwise>
                            </c:choose>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '1200000' && minPrice == '800000'}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice5" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice5" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=1200000&minPrice=800000')">
                                </c:otherwise>
                            </c:choose>
                        ...
                        <div class="form-check ml-xl-5">
                            <c:choose>
                                <c:when test = "${maxPrice == '1800000' && minPrice == '1200000'}">
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice6" value="" checked onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}')">
                                </c:when>
                                <c:otherwise>
                                    <input class="form-check-input" type="radio" name="filterPrice" id="filterPrice6" value="" onclick="requestProductFilter('Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&maxPrice=1800000&minPrice=1200000')">
                                </c:otherwise>
                            </c:choose>
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <c:if test = "${currentPage > 1}">
                        <a class="page-link" href="Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${currentPage-1}<c:if test = '${maxPrice != null}'>&maxPrice=${maxPrice}</c:if><c:if test = '${minPrice != null}'>&minPrice=${minPrice}</c:if>" aria-label="Previous">
                ...
                <c:forEach var = "i" begin = "1" end = "${totalPage}">
                    <li class='page-item'><a class='page-link <c:if test = "${currentPage == i}">text-danger</c:if>' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${i}<c:if test = "${maxPrice != null}">&maxPrice=${maxPrice}</c:if><c:if test = "${minPrice != null}">&minPrice=${minPrice}</c:if>'>${i}</a></li>
                </c:forEach>
                <li class="page-item">
                    <c:if test = "${currentPage < totalPage}">
                        <a class="page-link" href="Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${currentPage+1}<c:if test = '${maxPrice != null}'>&maxPrice=${maxPrice}</c:if><c:if test = '${minPrice != null}'>&minPrice=${minPrice}</c:if>" aria-label="Next">
